...
• תאר את האירוע/המגמה הגלובלית (גם אם אינה פיננסית במהותה)
• הסבר את שרשרת ההשפעה: אירוע → מחיר נפט/ריבית/מטבע → סקטור → שוק
• ציין אם זו מגמה קצרת/ארוכת טווח
• דוגמאות לחפש: מתיחות גיאופוליטית → נפט → אינפלציה → פד; בחירות → מדיניות רגולציה → סקטור; שינוי אקלים → תשתיות/אנרגיה; AI → כוח עיבוד → חשמל
לפחות 4-5 קשרים. זהו את המגמות הגדולות שמעצבות את השוק כרגע.
...
### שווקים גלובליים
אסיה ואירופה עם מספרים. הסבר קצר לתנועה חריגה, כולל הקשר לאירועים עולמיים אם רלוונטי.

### מדד פחד ותאוות בצע
0-25=פחד קיצוני, 26-45=פחד, 46-55=ניטרלי, 56-75=חמדנות, 76-100=חמדנות קיצונית. פרש את הציון.

### סבב סקטורים
לכל סקטור: שם, סימבול ETF, אחוז שינוי, חץ ▲/▼. נתח מה הרוטציה מעידה, כולל קשר לאירועים מאקרו.

### מניות בולטות – עולי ויורדי שער
מניות חריגות עם אחוזים. הסבר סיבה — כולל אם הסיבה היא אירוע עולמי לא-פיננסי.
...
### ניתוח חדשות מרכזיות
5-6 חדשות — שלב חדשות פיננסיות ואירועים עולמיים גם יחד. לכל חדשה: כותרת נושא, מה קרה עם מספרים, משמעות למשקיעים.

### מסקנות ומה לעקוב אחריו היום, {TODAY_SHORT}
3-4 נקודות ממוספרות — כולל לפחות נקודה אחת על מגמה/סיכון גלובלי שיש לעקוב אחריו.
...
• שער דולר/שקל עם פרשנות — חבר לאירועים גלובליים אם רלוונטי (מתיחות גיאופוליטית, מדיניות ריבית וכו')
• קורלציה עם וול סטריט ועם אירועים אזוריים/עולמיים
