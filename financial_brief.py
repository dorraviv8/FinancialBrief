        ...
        try:
            ...
            for entry in feed.entries:
                ...
                if pub:
                    ...
                    pub_str = "תאריך לא ידוע"
                items.append({"source": source, "title": title, "published": pub_str})
...
כלול רק מניות שנמצאות במדד S&P 500. לכל מניה: שם החברה, סימבול, אחוז שינוי בסגירה האחרונה.
הסבר את הסיבה לתנועה — כולל אם נובעת מאירוע עולמי, דוח רווחים, או חדשות ספציפיות.
אם אין נתונים על מניות S&P 500 ספציפיות — דלג על סעיף זה לחלוטין.
...
רק אירועים משמעותיים: החלטות ריבית פד, נתוני CPI/PPI/GDP/תעסוקה, רווחים של חברות >100B$, נאומי יו"ר הפד.
אם אין אירועים משמעותיים — דלג על סעיף זה לחלוטין ואל תכתוב אותו כלל.
